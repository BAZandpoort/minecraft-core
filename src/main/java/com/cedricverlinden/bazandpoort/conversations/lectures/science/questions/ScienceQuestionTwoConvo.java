...
public class ScienceQuestionTwoConvo implements Prompt {

	String question = (String) ScienceConvo.questions.keySet().toArray()[1];
	...
	public @Nullable Prompt acceptInput(@NotNull ConversationContext context, @Nullable String input) {
		...
		return new ScienceQuestionThreeConvo();
	}
}