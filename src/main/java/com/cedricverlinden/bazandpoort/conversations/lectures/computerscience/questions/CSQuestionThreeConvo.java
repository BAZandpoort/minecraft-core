...
public class CSQuestionThreeConvo implements Prompt {

	String question = (String) ComputerScienceConvo.questions.keySet().toArray()[2];
	...
	public @Nullable Prompt acceptInput(@NotNull ConversationContext context, @Nullable String input) {
		...
		return new CSQuestionFourConvo();
	}
}
