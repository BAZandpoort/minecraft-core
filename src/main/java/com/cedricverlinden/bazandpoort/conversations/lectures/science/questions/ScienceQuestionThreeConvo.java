...
public class ScienceQuestionThreeConvo implements Prompt {

	String question = (String) ScienceConvo.questions.keySet().toArray()[2];
	...
	public @Nullable Prompt acceptInput(@NotNull ConversationContext context, @Nullable String input) {
		...
		return new ScienceQuestionFourConvo();
	}
}