...
public class EconomyQuestionOneConvo implements Prompt {

	String question = (String) EconomyConvo.questions.keySet().toArray()[0];
	...
	public @Nullable Prompt acceptInput(@NotNull ConversationContext context, @Nullable String input) {
		...
		return new EconomyQuestionTwoConvo();
	}
}
