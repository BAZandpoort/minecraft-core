...
import com.cedricverlinden.bazandpoort.conversations.lectures.economy.questions.EconomyQuestionOneConvo;
...
public class EconomyReadyConvo extends ValidatingPrompt {
	...
	protected @Nullable Prompt acceptValidatedInput(@NotNull ConversationContext context, @NotNull String input) {
		switch (input.toLowerCase()) {
			case "ja" -> {
				PlayerManager.getPlayer((Player) context.getForWhom()).setCurrentLecture("economy");
				return new EconomyQuestionOneConvo();
			}
