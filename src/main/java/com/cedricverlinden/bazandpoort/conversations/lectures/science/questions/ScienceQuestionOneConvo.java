...
public class ScienceQuestionOneConvo implements Prompt {

	String question = (String) ScienceConvo.questions.keySet().toArray()[0];
	...
	public @Nullable Prompt acceptInput(@NotNull ConversationContext context, @Nullable String input) {
		...
		return new ScienceQuestionTwoConvo();
	}
}