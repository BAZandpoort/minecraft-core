...
public class EconomyQuestionTwoConvo implements Prompt {

	String question = (String) EconomyConvo.questions.keySet().toArray()[1];

	@Override
	public @NotNull String getPromptText(@NotNull ConversationContext context) {
		context.getForWhom().sendRawMessage(ChatUtil.color("&r"));
		return ChatUtil.color("&a&lVraag 2: &f" + question);
	}
	...
	public @Nullable Prompt acceptInput(@NotNull ConversationContext context, @Nullable String input) {
		...
		return new EconomyQuestionThreeConvo();
	}
}
