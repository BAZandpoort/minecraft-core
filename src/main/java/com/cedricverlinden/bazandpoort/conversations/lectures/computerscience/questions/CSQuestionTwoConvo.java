...
public class CSQuestionTwoConvo implements Prompt {

	String question = (String) ComputerScienceConvo.questions.keySet().toArray()[1];
	...
	public @Nullable Prompt acceptInput(@NotNull ConversationContext context, @Nullable String input) {
		...
		return new CSQuestionThreeConvo();
	}
}
